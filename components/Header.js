        ...
        <div className="bg-white flex items-center p-2 shadow-md top-0 sticky z-50 h-16">
            ...
            <div className="flex flex-grow justify-center mx-2">
                <div className="flex items-center">
                    {/*home icon*/}
                    <div className="flex items-center h-14 px-4 md:px-10
                     rounded-md md:hover:bg-gray-100 cursor-pointer">
            ...
            <div className="flex items-center justify-end min-w-fit space-x-2">
                ...
                <AiFillMessage className="hidden lg:inline-flex h-10 w-10 bg-gray-200 text-gray-600 rounded-full
                p-2 cursor-pointer hover:bg-gray-300" size={20}/>

                <AiFillBell className="hidden lg:inline-flex h-10 w-10 bg-gray-200 text-gray-600 rounded-full
                p-2 cursor-pointer hover:bg-gray-300" size={20}/>

                <MdOutlineExpandMore className="hidden lg:inline-flex h-10 w-10 bg-gray-200 text-gray-600 rounded-full
                p-2 cursor-pointer hover:bg-gray-300" size={20}/>
            </div>
        </div>
    );
